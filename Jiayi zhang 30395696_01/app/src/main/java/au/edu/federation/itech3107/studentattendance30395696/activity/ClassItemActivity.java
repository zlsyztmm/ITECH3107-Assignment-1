...
//
//        startDate.set(2023,0,2);
//        endDate.set(2025,1,5);
//
//        TimePickerView pvTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
//            @Override
//            public void onTimeSelect(Date date, View v) {
//                Log.i("TAG123456", "onTimeSelect: " + date);
//            }
//        })
        ...
        subBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(classNum.getText().toString())) {
                    Toast.makeText(ClassItemActivity.this, "课程号还未填写", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(className.getText().toString())) {
                    Toast.makeText(ClassItemActivity.this, "课程名字还未填写", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (startTime.getText().toString().trim().equals("点击选择开始时间")) {
                    Toast.makeText(ClassItemActivity.this, "你还未选择开始时间", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (endTime.getText().toString().trim().equals("点击选择结束时间")) {
                    Toast.makeText(ClassItemActivity.this, "你还未选择结束时间", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        endTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkFlag) {
                    ...
                    Toast.makeText(ClassItemActivity.this, "请选择开始时间", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
