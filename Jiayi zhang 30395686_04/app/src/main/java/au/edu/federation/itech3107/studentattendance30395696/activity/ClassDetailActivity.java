...
public class ClassDetailActivity extends Activity {
    ...
    private void initView() {
        ...
        // Set the text of TextViews with class details
        nameText.setText("Course Number:" + course.num);
        nameText.setText("Course Name:" + course.name);
        startText.setText("Start Time:" + course.startTime);
        endText.setText("End Time:" + course.endTime);
        ...
        savaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Handle click event for saving changes
                ...
                Toast.makeText(ClassDetailActivity.this, "save", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    // Define a custom RecyclerView adapter for students
    public static class StudentRecyAdapter extends BaseQuickAdapter<Student, StudentRecyAdapter.ViewHo> {
        ...
        protected void convert(ViewHo helper, Student item) {
            ...
            helper.nameTextView.setText("Name:\n" + item.name);
